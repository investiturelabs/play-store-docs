...
Pages will be live within a few minutes.

## Adding a New App

1. Create a new folder with the app name (lowercase, hyphenated)
2. Add `privacy-policy.html` and `delete-account.html`
3. Update `index.html` with links to the new app's documents
